...
def _create_application_tables() -> None:
    ...
    with conn.cursor() as cur:
        ...
        # share_links: maps short IDs to gzip+base64-encoded state blobs.
        # The DB is a pure key-value shortener; all app state lives in full_state.
        # UNLOGGED: consistent with other cache tables; durability not required since
        # a lost link just shows "not found" to the user.
        cur.execute(
            """
