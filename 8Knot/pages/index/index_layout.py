...
layout = html.Div(
    dbc.Container(
        [
            ...
            # share URL generated by the share-graph callback
            dcc.Store(id="share-url-store", storage_type="memory", data=""),
            # set to True by handle_share_url_load to bypass the search-button guard in run_queries
            dcc.Store(id="share-load-trigger", storage_type="memory", data=None),
            dcc.Location(id="url"),
            # Modal shown when a share link is created
            dbc.Modal(
                [
                    ...
                    dbc.ModalBody(
                        [
                            html.P(
                                "Copy the link below to share this graph with the current repo selection.",
                            ...
                            html.Small(
                                "This link is specific to this 8Knot instance.",
            ...
            # Toast for errors when loading a shared URL (expired link, unknown graph, etc.)
            dbc.Toast(
                id="share-load-toast",
                header="Shared link",
                is_open=False,
                ...
                duration=6000,
                icon="warning",
                style={"position": "fixed", "top": 80, "right": 20, "zIndex": 9999, "minWidth": 300},
            ),
